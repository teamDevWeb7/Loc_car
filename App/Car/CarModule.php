...
class CarModule extends AbstractModule{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->router->get('/addVehicule', [$carAction, 'addCar'], 'Car.add');

        $this->router->get('/listCar', [$carAction, 'listCar'], 'Car.list');

        $this->router->post('/listCar', [$carAction, 'listCar']);

        $this->router->post('/addVehicule', [$carAction, 'addCar']);
        ...
        $this->router->get('/delete/{id:[\d]+}', [$carAction, 'remove'], 'car.delete');
        ...
        $this->router->get('/marqueDelete/{id:[\d]+}', [$marqueAction, 'remove'], 'marque.delete');
